...
cp -r /Users/mi/Documents/HBuilderProjects/shopMe/religion-manager/dist/** ./nginx/html/dist
...
echo "begin copy phone "
cp ../ruoyi-modules/phone/target/phone.jar ./ruoyi/modules/phone/jar


echo "begin copy religion "
cp ../ruoyi-modules/religion/target/religion.jar ./ruoyi/modules/religion/jar
