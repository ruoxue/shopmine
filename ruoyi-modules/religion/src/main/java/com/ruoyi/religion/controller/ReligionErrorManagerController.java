 ...
 */
@RestController
@RequestMapping("/religionErrorManager")
public class ReligionErrorManagerController extends BaseController
{
    @Autowired
     ...
     * 查询违规登记列表
     */
    @RequiresPermissions("religion:religionErrorManager:list")
    @GetMapping("/list")
     ...
     * 导出违规登记列表
     */
    @RequiresPermissions("religion:religionErrorManager:export")
     ...
     * 获取违规登记详细信息
     */
    @RequiresPermissions("religion:religionErrorManager:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增违规登记
     */
    @RequiresPermissions("religion:religionErrorManager:add")
     ...
     * 修改违规登记
     */
    @RequiresPermissions("religion:religionErrorManager:edit")
     ...
     * 删除违规登记
     */
    @RequiresPermissions("religion:religionErrorManager:remove")
