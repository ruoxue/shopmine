...
public class TAreaController extends BaseController
{
     ...
     * 查询地区码列表
     */
    @RequiresPermissions("phone:tArea:list")
    @GetMapping("/list")
     ...
     * 导出地区码列表
     */
    @RequiresPermissions("phone:tArea:export")
     ...
     * 获取地区码详细信息
     */
    @RequiresPermissions("phone:tArea:query")
     ...
     * 新增地区码
     */
    @RequiresPermissions("phone:tArea:add")
     ...
     * 修改地区码
     */
    @RequiresPermissions("phone:tArea:edit")
     ...
     * 删除地区码
     */
    @RequiresPermissions("phone:tArea:remove")
