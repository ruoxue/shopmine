 ...
 */
@RestController
@RequestMapping("/tPhoneNumber")
public class TPhoneNumberController extends BaseController
{
    @Autowired
     ...
     * 查询手机管理列表
     */
    @RequiresPermissions("phone:tPhoneNumber:list")
    @GetMapping("/list")
     ...
     * 导出手机管理列表
     */
    @RequiresPermissions("phone:tPhoneNumber:export")
     ...
     * 获取手机管理详细信息
     */
    @RequiresPermissions("phone:tPhoneNumber:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增手机管理
     */
    @RequiresPermissions("phone:tPhoneNumber:add")
     ...
     * 修改手机管理
     */
    @RequiresPermissions("phone:tPhoneNumber:edit")
     ...
     * 删除手机管理
     */
    @RequiresPermissions("phone:tPhoneNumber:remove")
