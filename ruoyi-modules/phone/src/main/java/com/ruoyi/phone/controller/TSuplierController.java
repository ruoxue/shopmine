 ...
 */
@RestController
@RequestMapping("/tSuplier")
public class TSuplierController extends BaseController
{
    @Autowired
     ...
     * 查询供应商列表
     */
    @RequiresPermissions("phone:tSuplier:list")
    @GetMapping("/list")
     ...
     * 导出供应商列表
     */
    @RequiresPermissions("phone:tSuplier:export")
     ...
     * 获取供应商详细信息
     */
    @RequiresPermissions("phone:tSuplier:query")
     ...
     * 新增供应商
     */
    @RequiresPermissions("phone:tSuplier:add")
     ...
     * 修改供应商
     */
    @RequiresPermissions("phone:tSuplier:edit")
     ...
     * 删除供应商
     */
    @RequiresPermissions("phone:tSuplier:remove")
    ...
    public AjaxResult editAmount(@RequestBody TSuplier tSuplier)
    {
        return toAjax(tSuplierService.editAmount(tSuplier));
    }
