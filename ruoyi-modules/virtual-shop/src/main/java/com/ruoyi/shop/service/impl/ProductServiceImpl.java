...
public class ProductServiceImpl implements IProductService {
    ...
    public int updateProduct(ProductPO product) {
        ...
        List<ProductSpec> specArr = product.getSpecArr();
        List<ProductSku> skus = product.getSkus();
        productSpecTitleService.deleteProductSpecTitleByGoodsId(product.getId());
        productSpecOptionService.deleteProductSpecOptionByGoodsId(product.getId());
        iProductSkuService.deleteProductSkuByGoodsId(product.getId());
