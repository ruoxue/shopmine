...
//                .timeExpire(DateUtil.format(reqDTO.getExpireTime(), "yyyy-MM-dd HH:mm:ss'T'HH:mm:ssXXX"))
...
//        request.setTimeExpire(DateUtil.format(reqDTO.getExpireTime(), "yyyy-MM-dd HH:mm:ss'T'HH:mm:ssXXX"));
...
//                .setSuccessTime(DateUtil.parse(result.getSuccessTime(), "yyyy-MM-dd HH:mm:ss'T'HH:mm:ssXXX"))
//
//                .build();
//    }
//
